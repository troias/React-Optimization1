        ...
        <div className="flex justify-center items-center">
          <Link href="/story">
            <Button
              ...
              className="lg:px-4 lg:py-3 flex justify-center items-center bg-indigo-500 py-2 px-3 rounded-3xl text-white hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-400 transition duration-300 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
            >
